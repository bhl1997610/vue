...
def refreshQrcode():
    ...
    if n == 12:
        ...
        # img.screenshot(".\\public\\images\\aaa.png")
    ...
    if driver.current_url == url:
        refreshQrcode()
            ...
            if first==True:
                ...
                time.sleep(2)
                # os.remove(".\\public\\images\\aaa.png")
                time.sleep(2)
                driver.find_element_by_xpath(
    ...
    try:
        ...
        for cltext in channeltext:
            ...
            if re.search("MP65", cltext) != None:
                ...
                #     mysql.updatePlayNum("干瞪眼", item.values()[
                #         0], item.values()[1], item.values()[2])
            ...
            for index in range(len(cols1)):
                ...
                if index == len(cols1)-1:
                    for i in info:
                        ...
                        # mysql.updateMagicDB("干瞪眼", i.values()[0], i.values()[1], i.values()[
                        #         2], i.values()[3], i.values()[4])
                        break
